...
public class Responsable extends Persona{
    ...
    public Responsable(int id_responsable, String tipo_responsabilidad, String curp, String nombre, String apellido, String telefono, String direccion, Date fecha_nacimiento) {
